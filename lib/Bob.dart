              ...
              children: <Widget>[
                ...
                Center(
                  child: Container(
                    ...
                    child: FlatButton(
                        ...
                        onPressed: _decryptSenderDESKey,
                        color: Colors.lightBlue,
                        child: Text(
                          "Your Partner's DES Key",
                ...
                Center(
                  child: Container(
                    ...
                    child: FlatButton(
                        //This button retrieves the value of the second user DES key
                        onPressed: sendBobDESKey,
                        color: Colors.lightGreen,
                        child: Text(
                          "2-Send Your 3DES Key",
                          style: TextStyle(color: Colors.black),
                        )),
                  ),
                ),
                ...
                Flexible(
                  child: new FirebaseAnimatedList(
                      query: databaseReference.reference().child('Alice_Chat'),
                      itemBuilder: (_, DataSnapshot snapshot,
                          Animation<double> animation, int index) {
                        TripleDes d=new TripleDes(Alice_Decrypted_DES);
                        print(Alice_Decrypted_DES+" HERE");
                        print(d.decryptTripleDES(snapshot.value.toString()));
                        return new ListTile(
                          tileColor: Colors.yellow[400],
                          title: new Text("Alice"),
                          subtitle: new Text(d.decryptTripleDES(snapshot.value.toString())),
                        );
                      }),
                ),
                Flexible(
                  child: new FirebaseAnimatedList(
                      query: databaseReference.reference().child('Bob_Chat'),
                      itemBuilder: (_, DataSnapshot snapshot,
                          Animation<double> animation, int index) {
                        return new ListTile(
